...
yq write $HOME/.tkg/config.yaml -i "AWS_B64ENCODED_CREDENTIALS" ""
...
yq write $HOME/.tkg/config.yaml -i "AWS_NODE_AZ" us-east-2a
yq write $HOME/.tkg/config.yaml -i "AWS_NODE_AZ_1" us-east-2b
yq write $HOME/.tkg/config.yaml -i "AWS_NODE_AZ_2" us-east-2c
...
yq write $HOME/.tkg/config.yaml -i "AWS_REGION" us-east-2
